	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form">
				...
				<label class="label-input100" for="phone">Enter phone number (optional)</label>
				<div class="wrap-input100">
					<input id="phone" class="input100" type="text" name="phone" placeholder="Eg. +65 8000 0000">
					<span class="focus-input100"></span>
				</div>

				<label class="label-input100" for="message">Message *</label>
				<div class="wrap-input100 validate-input" data-validate = "Message is required">
					<textarea id="message" class="input100" name="message" placeholder="Drop us a message"></textarea>
					<span class="focus-input100"></span>
				</div>
			...
			<div class="contact100-more flex-col-c-m" style="background-image: url('../img/rafael-garcin-ISQ3M9fPa0g-unsplash.jpg');">
				<div class="flex-w size1 p-b-47">
					...
					<div class="flex-col size2">
						...
						<span class="txt2">
							World Crest 8th floor, 32 Mala Road Pali Hill, Mumbai-400050
						</span>
					</div>
				</div>
